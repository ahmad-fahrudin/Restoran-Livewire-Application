        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Category Baru</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form wire:submit.prevent="save" id="myForm">
                        <div class="form-group">
                            <label for="category" class="col-form-label col-sm-2">Nama :</label>
    ...
    <script class="text/javascript">
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    name: {
                        required: 'Tolong masukkan nama Category',
                    },
                },
                errorElement: 'span',
